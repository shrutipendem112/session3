...
public class Demo {
	...
	static void display() {
		System.out.println("Samples collected: "+Demo.samplesCollected + " in rounds " +Demo.round);
	}
	
//	Asif has gone for a walk in the park. 
//	He makes rounds in the park multiple times and during each round, he collects some leaf samples. 
